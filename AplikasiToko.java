...
public class AplikasiToko extends JFrame{   
	...
	final static String StringDriver="com.mysql.jdbc.Driver";   final static String StringConnection="jdbc:mysql://localhost:3306/DbTokoABC?user=root&password="; 
  ...
  /*Mendefinisikan komponen-komponen untuk Form Barang*/     
    						...
    						do { 
    							ModelTabelPenjualan.insertRow(ModelTabelPenjualan.getRowCount(),
    								new Object[]{ModelTabelPenjualan.getRowCount()+1,
    									...
    									rset.getString("Harga"),rset.getString("Qty"),rset.getString("SubTotal")});                 
    						} while (rset.next());                 
    						sta.close();                 
    						rset.close();                             
    ...
    LblNamaBarang.setBounds(30,45,160,20);     
       ...
       pnlJualDaftarBarang.add(TblJualDaftarBarangPilih); TblJualDaftarBarangBatal.setBounds((frmJualDaftarBarang.getWidth()/2)+20,frmJualDaftarBarang.getHeight()-85,80,30);     
       ...
       for (i=0;i<=3;i++){       
       	...
       	pnlCustomerJual = new JPanel(); pnlCustomerJual.setBorder(BorderFactory.createTitledBorder("Customer"));     
       	...
       	private class TombolDaftarCustomerHandler implements ActionListener {     
       		...
       		private class TombolJualDaftarBarangHandler implements ActionListener {     
       			public void actionPerformed(ActionEvent e){       
       				JButton TblPilih = (JButton)e.getSource();       
       				Boolean JDBC_Err = false;       if (TblPilih.getText().equals("Pilih")) {         
       					if (TabelJualDaftarBarang.getSelectedRow()>=0){ TxtKodeBarangJual.setText((String)TabelJualDaftarBarang.getModel().getValueAt(TabelJualDaftarBarang.getSelectedRow(),0));           
       				...
       				if (TblPilih.getText().equals("Daftar")) {         
       					...
       					if (!JDBC_Err){           
       						try {             
       							...
       							while (rset.next()){ 
       								ModelTabelDaftarBarang.insertRow(ModelTabelDaftarBarang.getRowCount(),new Object[]{
       				...
       				public void actionPerformed(ActionEvent e){       
       					...
       					if (TblPilih==TblJualCustomerDaftar) {         
       						...
       						if (ada){           
       							...
       							ModelTabelPenjualan.insertRow(ModelTabelPenjualan.getRowCount(),
       							new Object[]{ModelTabelPenjualan.getRowCount()+
       							1,TxtKodeBarangJual.getText(),TxtNamaBarangJual.getText(),TxtHargaBarangJual.getText(),TxtJumlahJual.getText(),TxtSubTotalJual.getText()});         
       						}         
   			...
   			if (rset.getRow()>0){                               
   				...
   				if (pilih==0){                 
   					SQLStatemen = "update TbPenjualan set Tanggal='"+Tanggal                     
   									+"', KodeCustomer='"+TxtKodeCustomerJual.getText()+"', IDUser='"+"B"                     
